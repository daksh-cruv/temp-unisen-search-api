...
from services.abbr_query_matcher import AbbrQueryMatcher
from services.check_pickle_exists import CheckPickleExists
from services.data_loader import DataLoader
from services.fuzzy_query_matcher import FuzzyQueryMatcher


class SearchEngine(AbbrQueryMatcher, FuzzyQueryMatcher):

    """
    Loads the Dataframe and PKL files into memory and performs search.
