...
class SubjectRecommendationSystem:
    def __init__(self, list_of_boards, subjects_queryset):
        ...
        self.streams_df = pd.read_csv(r"services\recommendation\train\all_streams.csv", header=0)
    ...
    def get_subjects_df_of_all_boards(self):
        """
        Get subjects of all boards from list of boards, and store them as dictionary,
    ...
    def select_df_by_board(self, board):
        """ Selects the board and returns the dataframe of subjects of that board"""
        return self.all_boards_subjects_df[board]

    def filter_logic_combinations(self, curriculum, education_level):
        """Filters the dataframe of streams based on the curriculum and education level"""
    ...
    def recomm_logic(self, input_subjects, curriculum, education_level):
        """Recommends different logic considering the requirement. If
    ...
    def encode_subjects(self, data):
        """Encodes the subjects in the CSV file which is loaded. It uses the
    ...
    def load_streams_and_get_subject_frequency(self, data):
        """Generates a dictionary containing the frequency of occurrence
    ...
    def get_modelwise_recommendation(self, input_subjects, data):
        """Recommends subjects using the Sentence Transformers Model. For each
    ...
    def get_initial_recommendations(self, data):
        """Generates a set of four initial recommendations based on the
    ...
    def get_streamwise_recommendations(self, input_subjects, data):
        """Generates a list of six recommendations using the Counter method and
